...
class SoalTigaActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_soal_tiga)
        ...
        var status =0
        if (bundles?.getString("s3").toString()=="a"){
            pilihanA.isChecked=true
        } else if (bundles?.getString("s3").toString()=="b") {
            pilihanB.isChecked=true
        } else if (bundles?.getString("s3").toString()=="c") {
            pilihanC.isChecked=true
        } else if (bundles?.getString("s3").toString()=="d") {
        ...
        btn_quiz_forward.setOnClickListener {
            var jawaban = '0'
            val intent = Intent(this, SoalEmpatActivity::class.java)
            ...
            bundle.putString("s3",jawaban.toString())
        ...
        btn_quiz_back.setOnClickListener {
            var jawaban = '0'
            val intent = Intent(this, SoalDuaActivity::class.java)
            if (pilihanA.isChecked){
                skor = skor - status
                jawaban = 'a'
            } else if (pilihanB.isChecked) {
