...
class SoalDuaActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var status =0
        if (bundles?.getString("s2").toString()=="a"){
            pilihanA.isChecked=true
        } else if (bundles?.getString("s2").toString()=="b") {
            pilihanB.isChecked=true
        } else if (bundles?.getString("s2").toString()=="c") {
            pilihanC.isChecked=true
            status=1
        } else if (bundles?.getString("s2").toString()=="d") {
        ...
        btn_quiz_forward.setOnClickListener {
            ...
            bundle.putString("s2",jawaban.toString())
