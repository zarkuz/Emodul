...
class SoalSatuActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var status =0
        if (bundles?.getString("s1").toString()=="a"){
            pilihanA.isChecked=true
            status=1
        } else if (bundles?.getString("s1").toString()=="b") {
            pilihanB.isChecked=true
        } else if (bundles?.getString("s1").toString()=="c") {
            pilihanC.isChecked=true
        } else if (bundles?.getString("s1").toString()=="d") {
        ...
        btn_quiz_forward.setOnClickListener {
            ...
            val bundle = Bundle()
            //Bundle Soal
            bundle.putString("s1", jawaban.toString())
