...
class SoalSebelasActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_soal_sebelas)
        ...
        var status =0
        if (bundles?.getString("s11").toString()=="a"){
            pilihanA.isChecked=true
        } else if (bundles?.getString("s11").toString()=="b") {
            pilihanB.isChecked=true
        } else if (bundles?.getString("s11").toString()=="c") {
            pilihanC.isChecked=true
            status=1
        } else if (bundles?.getString("s11").toString()=="d") {
        ...
        btn_quiz_forward.setOnClickListener {
            ...
            bundle.putString("s11",jawaban.toString())
        ...
        btn_quiz_back.setOnClickListener {
            var jawaban = '0'
            val intent = Intent(this, SoalSepuluhActivity::class.java)
            if (pilihanA.isChecked){
                skor = skor - status
                jawaban = 'a'
            } else if (pilihanB.isChecked) {
