...
class SoalLimaActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var status =0
        if (bundles?.getString("s5").toString()=="a"){
            pilihanA.isChecked=true
        } else if (bundles?.getString("s5").toString()=="b") {
            pilihanB.isChecked=true
            status=1
        } else if (bundles?.getString("s5").toString()=="c") {
            pilihanC.isChecked=true
        } else if (bundles?.getString("s5").toString()=="d") {
        ...
        btn_quiz_forward.setOnClickListener {
            ...
            bundle.putString("s5",jawaban.toString())
