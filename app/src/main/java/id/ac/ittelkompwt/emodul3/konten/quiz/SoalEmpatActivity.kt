...
class SoalEmpatActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_soal_empat)
        ...
        var status =0
        if (bundles?.getString("s4").toString()=="a"){
            pilihanA.isChecked=true
            status=1
        } else if (bundles?.getString("s4").toString()=="b") {
            pilihanB.isChecked=true
        } else if (bundles?.getString("s4").toString()=="c") {
            pilihanC.isChecked=true
        } else if (bundles?.getString("s4").toString()=="d") {
        ...
        btn_quiz_forward.setOnClickListener {
            var jawaban = '0'
            val intent = Intent(this, SoalLimaActivity::class.java)
            ...
            bundle.putString("s4",jawaban.toString())
        ...
        btn_quiz_back.setOnClickListener {
            var jawaban = '0'
            val intent = Intent(this, SoalTigaActivity::class.java)
            if (pilihanA.isChecked){
                skor = skor - status
                jawaban = 'a' +1
            } else if (pilihanB.isChecked) {
