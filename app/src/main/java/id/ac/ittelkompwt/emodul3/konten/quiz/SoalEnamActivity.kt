...
class SoalEnamActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_soal_enam)
        ...
        var status =0
        if (bundles?.getString("s6").toString()=="a"){
            pilihanA.isChecked=true
        } else if (bundles?.getString("s6").toString()=="b") {
            pilihanB.isChecked=true
        } else if (bundles?.getString("s6").toString()=="c") {
            pilihanC.isChecked=true
        } else if (bundles?.getString("s6").toString()=="d") {
        ...
        btn_quiz_forward.setOnClickListener {
            ...
            bundle.putString("s6",jawaban.toString())
