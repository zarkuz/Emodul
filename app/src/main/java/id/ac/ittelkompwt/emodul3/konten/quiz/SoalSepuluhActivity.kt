...
class SoalSepuluhActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_soal_sepuluh)
        ...
        var status =0
        if (bundles?.getString("s10").toString()=="a"){
            pilihanA.isChecked=true
        } else if (bundles?.getString("s10").toString()=="b") {
            pilihanB.isChecked=true
        } else if (bundles?.getString("s10").toString()=="c") {
            pilihanC.isChecked=true
            status=1
        } else if (bundles?.getString("s10").toString()=="d") {
        ...
        btn_quiz_forward.setOnClickListener {
            ...
            bundle.putString("s10",jawaban.toString())
