...
class SoalTujuhActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_soal_tujuh)
        ...
        var status =0
        if (bundles?.getString("s7").toString()=="a"){
            pilihanA.isChecked=true
        } else if (bundles?.getString("s7").toString()=="b") {
            pilihanB.isChecked=true
        } else if (bundles?.getString("s7").toString()=="c") {
            pilihanC.isChecked=true
        } else if (bundles?.getString("s7").toString()=="d") {
        ...
        btn_quiz_forward.setOnClickListener {
            ...
            bundle.putString("s7",jawaban.toString())
